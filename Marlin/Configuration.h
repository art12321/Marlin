...
#define STRING_CONFIG_H_AUTHOR "(ArtWasHere, CR-10 / SKR Mini E3 V3)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "BAJA-10-120324"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 55.14
  #define DEFAULT_bedKi 9.85
  #define DEFAULT_bedKd 205.86
 ...
 * With FT_MOTION requires ENDSTOP_INTERRUPTS_FE
 */
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, -27, -1.3  }
...
#define Z_PROBE_FEEDRATE_FAST (166*60)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE + 29) / 2)  // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE + 27) / 2)  // (mm) Y point for Z homing

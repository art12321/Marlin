...
#define STRING_CONFIG_H_AUTHOR "(Art, Ender-5_bugfix)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "pt100_diode"
...
#define PIDTEMP
#define BANG_MAX 235     // Limits current to nozzle while in bang-bang mode; 255=full current
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  21.73 }
    #define DEFAULT_Ki_LIST {   1.54 }
    #define DEFAULT_Kd_LIST { 76.55 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 791.8, 415 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -3, -1 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 32
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 33, 33, 33, 33 } // (mm) Left, Front, Right, Back insets
...
#define NEOPIXEL_LED
  ...
  //#define NEOPIXEL_PIN     4       // LED driving pin ((Art_Note: This is commented because it is defined in pins_BTT_SKR_V1.4.h)))
